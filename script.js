...
const PROJECTS = [
  ...
  },
  {
    ...
    year: '202X — Engine · Tech',
    tags: ['Tag1', 'Tag2', 'Tag3'],
    desc: 'Descrivi qui il tuo progetto. Cosa hai costruito, quali sfide tecniche hai affrontato, qual è il tuo contributo specifico.',
    links: [{ label: 'GitHub ↗', url: '#' }, { label: 'Video ↗', url: '#' }],
    slides: [
      { label: 'Screenshot 1', color: '#111' },
      { label: 'Screenshot 2', color: '#0f110d' }
    ]
  }
];
